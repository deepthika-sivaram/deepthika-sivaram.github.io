    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <p>Built a real-time AI-powered attendee–sponsor matching platform using React, Firebase, and multi-agent LLM orchestration, reducing manual pairing from hours to seconds.</p>
            </div>
            <div className="project">
